...
\begin{abstract}
    Short abstract, max 100 words. Remember, max 3 page report, including references!
\end{abstract}
...
\begin{itemize}
    \item Shortly describe the method you are using 4DVAR/3DVAR/EKF etc.
    \item Which packages and frameworks do you use....
\end{itemize}
...
\begin{itemize}
    \item Report on usability of the chosen packages/frameworks with respect to ease of installing, using etc.
